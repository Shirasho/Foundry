...
{
    public sealed class MultOperationSyntax : OperationSyntax
    {
        internal MultOperationSyntax(ISyntax? owner, in Instruction instruction)
            : base("mult", instruction, owner)
        {
        }
        ...
        protected override IEnumerable<string> GetMIPSLines(bool includeComments)
        {
            ...
            yield return $"mult\t{Instruction.RS}, {Instruction.RT}";
        }
    }
}
